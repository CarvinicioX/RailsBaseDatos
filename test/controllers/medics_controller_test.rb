...
class MedicsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create medic" do
    assert_difference('Medic.count') do
      post medics_url, params: { medic: { birth_date: @medic.birth_date, name: @medic.name, specialty: @medic.specialty, surname: @medic.surname } }
    end
  ...
  test "should update medic" do
    patch medic_url(@medic), params: { medic: { birth_date: @medic.birth_date, name: @medic.name, specialty: @medic.specialty, surname: @medic.surname } }
